  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">follower page</li>
      </ol>
    </section>
    		...
    		<div class = "col-md-12">
		      ...
		      <div class="box">
		        <div class="box-header with-border">
		          <h3 class="box-title"><i class="fa fa-bar-chart-o"></i>关注型网络拓扑图</h3>
		
		          <div class="box-tools pull-right">
		            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="zhedie" title="折叠窗口"><i class="fa fa-minus"></i></button>
					<div class="btn-group">
					  <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown"><i class="fa fa-refresh"></i></button>
					  <ul class="dropdown-menu" role="menu">
					    <li><a href="#" onclick = "getFollowerNetwork(100,null);">任取100个节点</a></li>
					    <li><a href="#" onclick = "getFollowerNetwork(500,null);">任取500个节点</a></li>
					    <li><a href="#" onclick = "getFollowerNetwork(1000,null);">任取1000个节点</a></li>
					    <li class="divider"></li>
					    <li><a href="#" onclick = "getFollowerNetwork(-1);">所有节点(可能时间较长)</a></li>
					  </ul>
					</div>
...
// 使用刚指定的配置项和数据显示图表。
getFollowerNetwork(500,null);

function getFollowerNetwork(nodeSize,nodeIds){
	myChart.showLoading();
	$.get('<%=basePath%>api/folltopo.do?nodeSize='+nodeSize+"&nodeIds="+nodeIds, function (webkitDep) {
	    myChart.hideLoading();
